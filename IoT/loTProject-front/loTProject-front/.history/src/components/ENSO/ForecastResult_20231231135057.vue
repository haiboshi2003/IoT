<template>
  <div class="pageContent">
    ...
    <div class="datePickerContainer">
      <el-date-picker @change="update_charts()" v-model="start_date" type="date" :format="datePickerFormat" :clearable="false" :disabledDate="limitedDateRange" style="width: 120px; height: 25px" />
      <!-- 使用格式化的日期直接在输入框中显示 -->
