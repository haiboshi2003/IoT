<template>
  <div class="pageContent">
    ...
    <div class="datePickerContainer">
      <el-date-picker @change="update_charts()" v-model="start_date" type="date" format="yyyy-MM-dd" value-format="yyyy-MM-dd" :clearable="false" :disabledDate="limitedDateRange" style="width: 120px; height: 25px" />
