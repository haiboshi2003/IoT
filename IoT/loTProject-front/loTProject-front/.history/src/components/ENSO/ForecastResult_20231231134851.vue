<template>
  <div class="pageContent">
    ...
    <div class="datePickerContainer">
      <el-date-picker @change="update_charts()" v-model="start_date" type="date" format="yyyy-MM-dd" value-format="yyyy-MM-dd" :clearable="false" :disabledDate="limitedDateRange" style="width: 120px; height: 25px" :value-format="datePickerFormat" />
      <!-- 使用格式化的日期直接在输入框中显示 -->
      <!-- <div class="text">日期: {{ formattedDate }}</div> -->
    </div>
...
export default {
  ...
  methods: {
    ...
    // 添加此方法以确保日期选择器的格式与 value-format 一致
